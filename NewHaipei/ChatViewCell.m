...
@interface ChatViewCell () <MLEmojiLabelDelegate>
...
//set方法
- (void)setModel:(Messageitem *)model
{
    _model = model;
...
- (void)setMessageOriginWithModel:(Messageitem *)model
{
    ...
    } else if (model.messageType == GPLMessageTypeSendToMe) {
